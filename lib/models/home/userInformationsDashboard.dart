...
class UserInformation {
  ...
  factory UserInformation.fromJson(Map<String, dynamic> json) => UserInformation(
    ...
    poMonthsCount: json["po_months_count"] == null ? null : json["po_months_count"],
    poIdleBalance: json["po_idle_balance"] == null ? null : json["po_idle_balance"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "po_months_count": poMonthsCount == null ? null : poMonthsCount,
    "po_idle_balance": poIdleBalance == null ? null : poIdleBalance,
    "po_salary": poSalary,
    "po_reg_per": poRegPer,
    "po_reg_amt": poRegAmt,
    "success": success,
