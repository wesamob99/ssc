...
class GetEarlyRetirementModel {
  ...
  factory GetEarlyRetirementModel.fromJson(Map<String, dynamic> json) => GetEarlyRetirementModel(
    pPerInfo: json["p_per_info"] == null ? [] : json["p_per_info"] == null ? [] : List<dynamic>.from(json["p_per_info"].map((x) => x)),
    pResult: json["P_Result"] == null ? [] : json["P_Result"] == null ? [] : List<List<PResult>>.from(json["P_Result"].map((x) => x == null ? [] : List<PResult>.from(x.map((x) => PResult.fromJson(x))))),
    pDoc: json["P_Doc"] == null ? [] : json["P_Doc"] == null ? [] : List<List<PDoc>>.from(json["P_Doc"].map((x) => x == null ? [] : List<PDoc>.from(x.map((x) => PDoc.fromJson(x))))),
    pDep: json["P_Dep"] == null ? [] : json["P_Dep"] == null ? [] : List<List<PDep>>.from(json["P_Dep"].map((x) => x == null ? [] : List<PDep>.from(x.map((x) => PDep.fromJson(x))))),
    pMessage: json["P_Message"] == null ? [] : json["P_Message"] == null ? [] : List<List<PMessage>>.from(json["P_Message"].map((x) => x == null ? [] : List<PMessage>.from(x.map((x) => PMessage.fromJson(x))))),
    pDepInfo: json["P_DEP_INFO"] == null ? [] : json["P_DEP_INFO"] == null ? [] : List<dynamic>.from(json["P_DEP_INFO"].map((x) => x)),
    pRelation: json["P_RELATION"] == null ? [] : json["P_RELATION"] == null ? [] : List<List<PRelation>>.from(json["P_RELATION"].map((x) => x == null ? [] : List<PRelation>.from(x.map((x) => PRelation.fromJson(x))))),
    pMarital: json["P_MARITAL"] == null ? [] : json["P_MARITAL"] == null ? [] : List<List<PMarital>>.from(json["P_MARITAL"].map((x) => x == null ? [] : List<PMarital>.from(x.map((x) => PMarital.fromJson(x))))),
    pLaonType: json["P_LAON_TYPE"] == null ? [] : json["P_LAON_TYPE"] == null ? [] : List<dynamic>.from(json["P_LAON_TYPE"].map((x) => x)),
    pDeadLoan: json["P_DEAD_LOAN"] == null ? [] : json["P_DEAD_LOAN"] == null ? [] : List<dynamic>.from(json["P_DEAD_LOAN"].map((x) => x)),
  );

  Map<String, dynamic> toJson() => {
    "p_per_info": pPerInfo == null ? [] : pPerInfo == null ? [] : List<dynamic>.from(pPerInfo.map((x) => x)),
    "P_Result": pResult == null ? [] : pResult == null ? [] : List<dynamic>.from(pResult.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_Doc": pDoc == null ? [] : pDoc == null ? [] : List<dynamic>.from(pDoc.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_Dep": pDep == null ? [] : pDep == null ? [] : List<dynamic>.from(pDep.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_Message": pMessage == null ? [] : pMessage == null ? [] : List<dynamic>.from(pMessage.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_DEP_INFO": pDepInfo == null ? [] : pDepInfo == null ? [] : List<dynamic>.from(pDepInfo.map((x) => x)),
    "P_RELATION": pRelation == null ? [] : pRelation == null ? [] : List<dynamic>.from(pRelation.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_MARITAL": pMarital == null ? [] : pMarital == null ? [] : List<dynamic>.from(pMarital.map((x) => x == null ? [] : List<dynamic>.from(x.map((x) => x.toJson())))),
    "P_LAON_TYPE": pLaonType == null ? [] : pLaonType == null ? [] : List<dynamic>.from(pLaonType.map((x) => x)),
    "P_DEAD_LOAN": pDeadLoan == null ? [] : pDeadLoan == null ? [] : List<dynamic>.from(pDeadLoan.map((x) => x)),
  };
}
...
class PDoc {
  ...
  factory PDoc.fromJson(Map<String, dynamic> json) => PDoc(
    id: json["ID"],
...
class PMessage {
  ...
  int poStatus;
  int poType;
  String poStatusDescAr;
  String poStatusDescEn;
