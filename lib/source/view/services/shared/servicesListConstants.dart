...
class ServicesList{
  ...
  static List<Service> quickAccessServices = [earlyRetirementRequest, individualsUnemploymentApplication, onePayment, reportAnAccident, accountStatement, membershipRequest];
