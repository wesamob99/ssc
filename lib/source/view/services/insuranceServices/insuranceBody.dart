...
import 'package:ssc/source/view/services/insuranceServices/screens/oneTimeRefundInquiry.dart';
                  ...
                  itemBuilder: (context, index2){
                    ...
                    ? Column(
                      children: [
                        InkWell(
                          onTap: (){
                            if(insuranceBenefitsServices[index2].title == 'oneTimeCompensationRequest'){
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) => OneTimeRefundInquiryScreen(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              getTranslated(insuranceBenefitsServices[index2].title, context),
                              style: TextStyle(
